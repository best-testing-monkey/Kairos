...
class KairosSettings:
    ...
    naive_baseline: bool = False  # oracle's real decision, no-peek accounting (see OrchestratorConfig)
    interval: str = "1d"
    ...
    def configure(cls, args) -> None:
        for attr in ("symbol", "lookback", "pred_len", "pred_samples",
                     ...
                     "no_prediction", "naive_baseline", "interval", "assets", "backtest_period"):
