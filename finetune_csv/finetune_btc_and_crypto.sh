...
cd finetune_csv
uv run finetune_base_model.py --config configs/finetune_btc_base.yaml
cd ..
...
cd finetune_csv
uv run finetune_base_model.py --config configs/finetune_btc_base_r2.yaml
cd ..
...
cd finetune_csv && uv run finetune_base_model.py --config configs/finetune_btc_base_r3.yaml
cd ..
