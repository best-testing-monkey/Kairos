...
- [x] E18-S04 `MLBracketStrategy` wrapper (docs/tickets/E18-S04-ml-bracket-strategy.md)
- [x] E18-S05 Offline comparison vs. static-percentile baseline (docs/tickets/E18-S05-tpsl-offline-validation.md)
...
- [x] E19-S03 Default-mode parity regression test (docs/tickets/E19-S03-prediction-usage-default-parity-test.md)
...
- [x] E20-S03 No-lookahead test (docs/tickets/E20-S03-distribution-as-bar-no-lookahead-test.md)
- [x] E20-S04 Indicator sensitivity + no-effect tests (docs/tickets/E20-S04-distribution-as-bar-indicator-sensitivity-test.md)
- [x] E20-S05 Offline comparison vs. `last_real_bar` mode (docs/tickets/E20-S05-distribution-as-bar-offline-comparison.md)
...
- [x] E21-S06 Fix `MLBracketStrategy` correctness bugs + add real test coverage (docs/tickets/E21-S06-fix-ml-bracket-strategy-correctness-and-tests.md)
