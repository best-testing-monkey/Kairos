...
- [ ] E14-S02 Fix select_finetune_candidate's interval-blind already_registered check (docs/tickets/E14-S02-finetune-candidate-interval-blind-registry-check.md)
